...
CJSON_TEST_SRC = cJSON.c test.c s2j.c
...
ifeq "$(IS_GCC_ABOVE_MIN_VERSION)" "1"
    CFLAGS += -fstack-protector-strong -std=c99
else
    CFLAGS += -fstack-protector -std=c99
endif

R_CFLAGS = -fPIC -std=c99 -pedantic -Wall -Werror -Wstrict-prototypes -Wwrite-strings -Wshadow -Winit-self -Wcast-align -Wformat=2 -Wmissing-prototypes -Wstrict-overflow=2 -Wcast-qual  -Wundef -Wswitch-default  $(CFLAGS)
